...
{
    public ThirdPersonOrbitCamBasic cameraInfo;
    ...
    void Update()
    {
        if (GameManager.instance.isGameOperational)
        {
            ...
            {
                changedFOV = true;
                playerCamera.GetComponent<ThirdPersonOrbitCamBasic>().SetFOV(sprintFOV);
            }
            else if (changedFOV)
            {
                playerCamera.GetComponent<ThirdPersonOrbitCamBasic>().ResetFOV();
                changedFOV = false;
            }
    ...
    {
        cameraInfo = playerCamera.GetComponent<ThirdPersonOrbitCamBasic>();
    }
}
